...
export default function Hero() {
  return (
    <section>
      ...
      <div className="">
        <div className="text-center relative bg-cover bg-center h-[30vh] md:h-[30vh] lg:h-[40vh] flex items-center">
          <div
          ...
          ></div>
          <div className="absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/3 md:translate-x-0  p-10 md:p-0 lg:p-10 z-10 flex flex-col items-center">
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-900 sm:mb-4">
              Experience Authentic Flavor
            </h2>
            <p className="text-sm sm:text-sm md:text-lg text-gray-600 sm:mb-4">
